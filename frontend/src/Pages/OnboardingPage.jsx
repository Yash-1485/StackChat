...
import { LoaderCircle, MapPinIcon, MessageSquareText, ShuffleIcon } from "lucide-react";
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex flex-col items-center justify-center space-y-3">
                            ...
                            <div className="flex items-center gap-2">
                                <button type="button" onClick={handleRandomAvatar} className="btn btn-accent rounded-lg">
                        ...
                        <button className="btn btn-primary w-full rounded-lg" disabled={isPending} type="submit">
                            {!isPending ? (
                                <>
